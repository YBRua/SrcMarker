...
from benchmark_mbxp import (MBCPPRunner, MBJPRunner, MBJSPRunner, compose_function_java,
                            compose_function_cpp, compose_function_javascript)
    ...
    for transformer in ropgen.get_transformers():
        ...
        for transform_key in transformer.get_available_transforms():
            ...
            for i, sample in enumerate(prog):
                ...
                transformer.xml_transform_all(input_xml_fpath, transform_key,
                                              output_xml_fpath)
            ...
            res, failures = runner.check_solutions(transformed_instances, n_processes=16)

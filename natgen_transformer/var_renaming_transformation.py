...
class VarRenamingTransformer(NatGenBaseTransformer):
    def __init__(self, parser_path: str, language: str):
        super(VarRenamingTransformer, self).__init__(
...
if __name__ == "__main__":
    ...
    for lang in ["c", "cpp", "java", "python", "php", "ruby", "js", "go", "cs"]:
        ...
        var_renamer = VarRenamingTransformer(parser_path, lang)
        print(lang)

...
class DeadCodeInserter(NatGenBaseTransformer):
    ...
    def insert_random_dead_code(self, code_string, max_node_in_statement=-1):
        ...
        statements = extract_statement_within_size(
            root,
            max_node_in_statement,
            statement_markers,
            code_string=code_string,
            tokenizer=self.tokenizer_function,
        )
...
if __name__ == "__main__":
    ...
    for lang in ["c", "cpp", "java", "python", "php", "ruby", "js", "go", "cs"]:
        ...
        dead_code_inserter = DeadCodeInserter(parser_path, lang)
        print(lang)

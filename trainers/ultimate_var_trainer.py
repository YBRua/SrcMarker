...
class UltimateVarWMTrainer:
    ...
    def _train_epoch(self, eid: int, dataloader: DataLoader):
        ...
        for bid, batch in enumerate(progress):
            ...
            vs_output = self.selector.var_selector_forward(code_feature, wm_feature)
            ...
            feat_warped = self.approximator(code_feature, vs_embds, padding_mask)
    ...
    def _test_epoch(self, eid: int, dataloader: DataLoader):
        ...
        for bid, batch in enumerate(dataloader):
            ...
            instances = self.transform_manager.get_original_instances(instance_ids)
